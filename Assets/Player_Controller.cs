...
public class Player_Controller : MonoBehaviour
{
	...
	[SerializeField]
	private AudioClip gun,ice,fire,win,lose,background,oh_yeah;
    ...
    private float start_time_sound_backgroup;
    public float time_sound_background;
    void Start()
    {
        ...
        Point_Player = 0;
		lose_game = false;
        start_time_sound_backgroup = Time.time;
    }

    // Update is called once per frame
    void Update()
    {
        if (Time.time > start_time_sound_backgroup)
        {
            audioSource.PlayOneShot(background);
            start_time_sound_backgroup = Time.time + time_sound_background;
    ...
    public void Say_Oh()
    {
        ...
        audioSource.PlayOneShot(oh_yeah);
    }
    ...
    {
        Point_Player += point;
        show_point.text = "Scores: " + Point_Player;
    }
